...
namespace Package\Page\Providers;
...
class PageServiceProvider extends ServiceProvider
{
     ...
     */
    protected $commands = [
        // 'Package\Page\Commands\PageSeedCommand'
    ];
    ...
    */
    public function publish()
    {
        if ($this->app->runningInConsole()) {
            ...
            // Chạy riêng
            $this->publishes($all, 'package/page');
            $this->publishes($assets, 'package/page/assets');
            $this->publishes($config, 'package/page/config');
