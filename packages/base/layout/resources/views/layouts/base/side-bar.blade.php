<aside id="sidebar" class="sidebar break-point-sm has-bg-image">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><path fill="currentColor" d="m10.828 12l4.95 4.95l-1.414 1.415L8 12l6.364-6.364l1.414 1.414z"/></svg>
    </a>
    <div class="image-wrapper">
        <img src="" alt="sidebar background" />
    </div>
    <div class="sidebar-layout">
        <div class="flex items-center after:none before:none justify-center h-16 border-b border-gray-200">
